...
contract ThisIsFine is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x2443e7416b917AdC9998865cC890D545E7D4AAC8; // Multisig wallet
    ...
    uint256 public _taxFee = 300; // 3%
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 250; // 2.5%
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _charityFee = 250; // 2.5%
